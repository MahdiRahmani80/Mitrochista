    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addTime', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 73179))),
            ],
        ),
        migrations.CreateModel(
            name='CourseComment',
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 78465))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 81906))),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 83721))),
            ],
        ),
        migrations.CreateModel(
            name='SocalMedia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 73744))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 83281))),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 80278))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 77995))),
                ('Course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.course')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.teacher')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('ip', models.CharField(max_length=20)),
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 13, 15, 55, 33, 82722))),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.course')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.user')),
            ],
        ),
